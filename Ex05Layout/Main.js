...
export default class Main extends Component{
    render(){
        return (
            // RN은 컴포넌트 1개만 return할 수 있음. 그래서 여러개를 배치하려면
            // ViewGroup용 컴포넌트가 하나 필요함. RN에서 그룹용 클래스가 View임

            // 1) 3개의 자식뷰 배치하기
            // <View>
            //     {/* 뷰의 크기값은 숫자(단위:dp)이거나 %단위로 지정할 수 있음 */}
            //     {/* 단위를 명시할 때는 문자열로 값을 지정해야 함 */}
            //     <View style={{width:50, height:50, backgroundColor:'red' }}></View>
            //     <View style={{width:100, height:100, backgroundColor:'green' }}></View>
            //     <View style={{width:'70%', height:150, backgroundColor:'blue' }}></View>
            // </View>

            // 2) 자식뷰들의 높이값을 숫자로 명시하면 디바이스별로 해상도에 대응하기 어려움
            //    자식뷰의 높이값을 화면 해상도의 비율에 맞게 설정하는 속성값: flex [마치 안드로이드의 layout-weight 과 흡사함]
            ...
            //    alignItems:'strech'모드는 사이즈가 없을 때만 가능함 [default 설정값임]
            ...
            //    뷰를 겹쳐서 배치해보기 [ position속성 : absolute ]
            <View style={{flex:1, flexDirection:'column'}}>
                {/* 크게 수직으로 2분할 [1:2 비율] */}
                ...
                <View style={{width:100, height:100, backgroundColor:'orange', position:'absolute', left:40, bottom:40, borderRadius:50}}></View>
