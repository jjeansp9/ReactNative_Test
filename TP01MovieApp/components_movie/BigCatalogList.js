...
export default BigCatalogList = (props)=>{
    ...
    // 영화정보를 받아오는 메소드
    useEffect(()=>{
        // 영화정보 url을 통해 json 데이터를 읽어오기
        // JS는 네트워크작업을 쉽게 해주기 위해 fetch 라는 라이브러리가 존재하며,
        // RN에서는 fetch 라이브러리가 기본 내장되어 있음
        // fetch()는 비동기방식 이기에 promiss [ .then() ]기법 사용
        ...
        // fetch 결과를 json분석하여 객체로 변환하여 받기
        fetch(props.url)
